...
def get_captcha_url(url_with_datadome):
    ...
    proxies = [
            "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance:u0a8c217b562505b8@43.152.113.55:2333",
...
#     proxies = [
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-Xs0qofGpM-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-mkjXP5M1c-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-vUz5fK2u3-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-0RwGbmOyH-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-hf54b0wbH-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-4HVEjaFyT-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-K81bP2QtY-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-dMxKgY4OD-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-ze0qTcqZr-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
# "u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance-session-UaAmzUhyl-sessTime-10:u0a8c217b562505b8@43.152.113.55:2333",
...
def test_register_page():
    ...
    captcha_url, cid = get_captcha_url(SITE_URL_WITH_DATADOME)
    # breakpoint()
    ...
    result = capmonster_solver(website_url=SITE_URL_WITH_DATADOME, captcha_url=captcha_url, cid=cid)
    # result = capmonster_solver(website_url=SITE_URL_WITH_DATADOME, captcha_url=captcha_url2, cid="Qv2bHoWqN4guL9N866eXQZBtOv2ghSc2ccTE2PdORHVA3Fz2GLyO6KFuu1R0Mg4~NLZDrFGtnYnUBV4LaL8DyQ~5bprOs4BP2kHiyDfVnpgP2koJtIyj3M7Bg7JzX4we")

    if result:
        cookieupdate = result.split(";")[0]
        headers['cookie'] = f"datadome={cookieupdate}"
        breakpoint()
        response = requests.get(SITE_URL_WITH_DATADOME, headers=headers, proxies=format_proxy("u0a8c217b562505b8-zone-custom-region-fr-st-hautsdefrance:u0a8c217b562505b8@43.152.113.55:2333"), timeout=(20, 20))
    # if cookieupdate:
    #     headers['cookie'] = f"datadome={cookieupdate}"
